...
static const enum videoScaleIntegerType {SCALE_INT_REDUCE=0, SCALE_INT_INCREASE, TOTAL_INT_SCALE};
...
static const enum ANIM_BACKGROUNDS {BG_TILES, BG_IMAGE, BG_NONE, BG_MAX};
