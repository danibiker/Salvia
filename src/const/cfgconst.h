...
namespace cfg {
	...
	typedef enum {emulators = 0, debug, resolution_width, resolution_height, fullscreen, path_prefix, alsaReset, background_music, mp3_file, aspectRatio, packedImages,
			scaleMode, scaleIntMode, syncMode, shaderMode, soundMode, fastForwardMult, libretrosystem, libretro_lang, libretro_save, libretro_state, libretro_core, libretro_core_version, 
